		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FioriTilesfor10Projects",
									"targetURL": "#FioriTilesfor10Projectsprojects10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FioriTilesfor10Projectsprojects10-display": {
								"semanticObject": "FioriTilesfor10Projectsprojects10",
								"action": "display",
								"description": "Fiori Tiles for 10 Projects",
								"title": "FioriTilesfor10Projects",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=FioriTilesfor10Projects.projects10",
									"url": sap.ui.require.toUrl("FioriTilesfor10Projects/projects10")
								}
							}
						}
					}
